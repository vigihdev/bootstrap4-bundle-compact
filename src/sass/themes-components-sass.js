...
const DIST_STYLES = Paths.ASSETS.THEMES_COMPONENTS.DIST;
const BUILDS_STYLES = Paths.ASSETS.THEMES_COMPONENTS.BUILDS;
...
module.exports.ThemesComponentsSass = {
    basepath: Paths.ASSETS.THEMES_COMPONENTS.BASEPATH,
    sass: sass,
    concat: {
        options: {
            separator: ';'
